                ...
                <div>
                  ...
                  <Link
                    ...
                    <Image
                      ...
                      height={24}
                    />
                    <h1 className="sm:text-3xl text-white text-xl font-bold ml-2 tracking-tight">
                      DECORION
                    </h1>
                  </Link>
                  <p className="text-sm md:text-base mt-3 italic">
                    Never before has building your ideal home been so simple.
                    Remodeling a home doesn't have to be a laborious process.
                    Use our cutting-edge home remodeling solutions to
                    save time and money!
                  </p>
                  {/* Social Icons  */}
