  ...
  return (
    <div className="mx-auto w-full px-4 flex justify-center py-4">
      <div className="grid grid-cols-1 lg:grid-cols-3 w-full gap-4">
        ...
        <div className="order-first lg:order-last col-span-1 lg:col-span-2 w-full max-w- max-h-[900px] flex flex-col items-center justify-start bg-white rounded-xl border border-gray-200 p-4 lg:p-7 overflow-y-auto no-scrollbar">
          <MyTabs
